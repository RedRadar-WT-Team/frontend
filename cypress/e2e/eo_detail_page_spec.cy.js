describe('Eos Detail Page', () => {
  ...
  it('displays title of EO', () => {
    cy.get('.EODetails')
    cy.get('h1').should('contain', "Further Amendment to Duties Addressing the Synthetic Opioid Supply Chain in the People's Republic of China")
  })

  it('displays the document number of EO', () => {
    cy.get('h2')
    .should('contain', "2025-03775")
  })

  it('displays the publication date of EO', () => {
    cy.get('h2')
    .should('contain', "March 07, 2025")
  })
